...
with wandb.init(project="LLMOps-Pycon2024",name=f"Prompt-Template ExecId-{args.IdExecution}", job_type="prompting-engineering") as run:
    ...
    artifact.add_file(local_path="/src/llms/prompt_template.txt", name="prompt_template.txt")
...
# Initialize Weave
weave.init(project="LLMOps-Pycon2024",name=f"Dataset-Evaluate ExecId-{args.IdExecution}", job_type="dataset-evaluate")
# Create a dataset
